"""
Django settings for modapp_8 project.
...
WSGI_APPLICATION = 'modapp_8.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "modapp_8 API",
    "DESCRIPTION": "API documentation for modapp_8 App",
    "VERSION": "v1",
}
